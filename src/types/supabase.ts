  ...
  public: {
    Tables: {
      ...
      custom_thumbnail_order_files: {
        ...
        Relationships: [
          {
            foreignKeyName: "custom_thumbnail_order_files_file_id_fkey";
            columns: ["file_id"];
            isOneToOne: false;
          ...
          {
            foreignKeyName: "custom_thumbnail_order_files_order_id_fkey";
            columns: ["order_id"];
            isOneToOne: false;
      ...
      custom_thumbnail_orders: {
        ...
        Relationships: [
          {
            foreignKeyName: "custom_thumbnail_orders_result_template_id_fkey";
          ...
          {
            foreignKeyName: "custom_thumbnail_orders_user_id_fkey";
            columns: ["user_id"];
            isOneToOne: false;
            referencedRelation: "users";
            referencedColumns: ["id"];
