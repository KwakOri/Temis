...
export function PublicRegisterForm({ onSuccess, onBack, className = '' }: PublicRegisterFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await registerPublic(formData.email, formData.password, formData.name);
