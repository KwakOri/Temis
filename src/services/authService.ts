...
export class AuthService {
  // 회원가입 토큰 유효성 검증
  static async validateSignupToken(token: string): Promise<SignupTokenValidateResponse> {
  ...
  // 이메일 인증
  static async verifyEmail(verifyData: VerifyEmailData): Promise<VerifyEmailResponse> {
  ...
  // 비밀번호 재설정
  static async resetPassword(resetData: ResetPasswordData): Promise<ResetPasswordResponse> {
