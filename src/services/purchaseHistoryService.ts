import { PurchaseHistoryResponse, UpdatePurchaseRequestData } from '@/types/purchaseHistory'
...
export class PurchaseHistoryService {
  ...
  static async updatePurchaseRequest(
    ...
    const response = await fetch(`${this.baseUrl}/purchase-requests/${requestId}`, {
      method: 'PUT',
      headers: {
