...
export const reviews: Review[] = [
  ...
  },
  {
    ...
    description:
      "(샘플디자인)같은 꾸밈 요소가 있었으면 좋겠습니다!!\n설정이 우주라서 SF 같은 느낌*(차가운/심플한)이 \n많은데 그것도 좋지만 조금 더 꾸밈 요소가 있어서\n화면이 좀 찼으면 좋겠습니다!! 이렇게 오마카세\n신청했는데 이렇게 나왔다구요? 이런데 왜않해?",
    size: "sm",
  },
  {
    title:
