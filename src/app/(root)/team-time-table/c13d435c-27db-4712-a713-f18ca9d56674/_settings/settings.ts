...
export const fontOption = {
  primary: 'KblJump',
  secondary: 'KblJumpCondensed',
  tertiary: 'KblJumpExtended',
  quaternary: '',
};
...
export const team_ids = [88, 84, 295];

export type TeamTimeTableMemberOrder = 'time' | 'member';

// time: 요일별 방송 시작 시간순, member: 아래 memberOrder 순서
export const teamTimeTableMemberOrder: TeamTimeTableMemberOrder = 'time';
