          ...
          <div className="min-w-0 flex-1 overflow-y-auto p-5">
              ...
              <div className="grid gap-2 rounded-xl border border-[var(--field-border)] bg-[var(--field)]/40 p-3">
                ...
                <label className="grid gap-1.5 text-[11px] font-semibold text-[var(--fg2)]">
                  ...
                  <StudioHexColorPicker
                    ...
                    onChange={(background) =>
                      onCardsCanvasChange({ background })
                    }
                  />
                </label>
                <GuideLayerSettings
                  ...
                  <>
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      <CanvasNumberField
                        ...
                        onChange={(height) =>
                          onTimetableCanvasChange({ height })
                        }
                      />
                    </div>
                    <label className="grid gap-1.5 text-[11px] font-semibold text-[var(--fg2)]">
              ...
              {document.domains?.timetable ? (
                <div className="grid gap-2">
                  {(
                    ...
                    const enabled =
                      timetableCapabilities[capabilityKey].enabled;
            ...
            >
                      ...
                      >
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            title={
                              source.enabled ? "Disable font" : "Enable font"
                            }
                            type="button"
                            onClick={() =>
                              onWebFontsChange(
              ...
              <div className="grid gap-2 rounded-xl border border-dashed border-[var(--field-border)] p-3">
                ...
                />
                <p className="text-[9px] font-medium leading-4 text-[var(--fg3)]">
                  Missing font metrics are added automatically: ascent 84%,
                  descent 16%, line gap 0%, and size adjust 100%. Explicit
