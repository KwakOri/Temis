    ...
    return {
      ...
      renderConfig: {
        ...
        assets: {
          ...
          artistOnByTheme: v2_withAllThemes(Imgs.first.artist.src),
          artistOffByTheme: v2_withAllThemes(null),
        ...
        assetDimensions: {
          ...
          artistOnByTheme: v2_withAllThemeDimensions(4000, 2250),
          artistOffByTheme: v2_withAllThemeDimensions(4000, 2250),
