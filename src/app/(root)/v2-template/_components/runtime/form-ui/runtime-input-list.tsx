...
import AdaptiveTimeRenderer from "./field-renderers/adaptive-time-renderer";
import TextRenderer from "./field-renderers/text-renderer";
import TextareaRenderer from "./field-renderers/textarea-renderer";
import { DayCard } from "./ui/day-card";
import { EntryCard } from "./ui/entry-card";
import OfflineMemoCard from "./ui/offline-memo-card";
import { buttonVariants, labelVariants } from "./ui/styles";
import { SubToggle } from "./ui/sub-toggle";
...
export interface RuntimeInputListProps {
  data: TDefaultCard[];
...
const RuntimeInputList: React.FC<RuntimeInputListProps> = ({
  data,
  onDataChange,
  globalData,
  onGlobalDataChange,
...
export default RuntimeInputList;
