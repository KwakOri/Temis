...
export const TimeTableFormTabs = ({
  ...
  return (
    <div className="flex w-full border-b border-timetable-card-border select-none bg-timetable-card-bg">
      {tabs.map((tab) => {
        ...
        return (
          <button
            ...
            className={`flex-1 py-3 px-2 text-sm font-semibold text-center transition-all duration-200 border-b-2 ${
              isActive
                ? "text-timetable-primary border-timetable-primary bg-[#1f2633]"
