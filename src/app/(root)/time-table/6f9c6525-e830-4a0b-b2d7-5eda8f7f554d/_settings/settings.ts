...
export const onlineCardWidth: number = 999;
export const onlineCardHeight: number = 569;
...
export const offlineCardWidth: number = 999;
export const offlineCardHeight: number = 569;
...
export const profileImageHeight = 2120;
