...
export const fontOption = {
  primary: "YUniverse",
  secondary: "SchoolSafetyAttendanceBook",
  tertiary: "",
  quaternary: "",
};
...
export const onlineCardWidth: number = 532;
export const onlineCardHeight: number = 713;
...
export const offlineCardWidth: number = 532;
export const offlineCardHeight: number = 713;
...
export const profileImageWidth = 1650;
export const profileImageHeight = 2200;
