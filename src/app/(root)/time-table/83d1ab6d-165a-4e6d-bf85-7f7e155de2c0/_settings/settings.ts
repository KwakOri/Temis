...
export const onlineCardWidth: number = 793;
export const onlineCardHeight: number = 698;
...
export const offlineCardWidth: number = 793;
export const offlineCardHeight: number = 698;
...
export const profileImageWidth = 1240;
export const profileImageHeight = 1680;
