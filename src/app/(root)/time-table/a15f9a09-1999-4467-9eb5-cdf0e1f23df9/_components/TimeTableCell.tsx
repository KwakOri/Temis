  ...
  return (
    <p
      style={{
        ...
        lineHeight: 1,
        fontFamily: fontOption.primary,
        fontWeight: isOffline ? 300 : 700,
        fontSize: isOffline ? 60 : 64,
        bottom: 80,
        color:
          colors[currentTheme || "first"][isOffline ? "primary" : "secondary"],
      }}
...
const TimeTableCell: React.FC<TimeTableCellProps> = ({
  ...
  if (time.isOffline) {
    return (
      ...
      >
        <StreamingDay day={time.day} isOffline={true} />
        <StreamingTime
  ...
  return (
    ...
    >
      <StreamingTime
        ...
        time={entryTime}
      />
      <StreamingDay day={time.day} isOffline={false} />
      <CellContentArea>
