...
export const onlineCardWidth: number = 634;
export const onlineCardHeight: number = 764;
...
export const offlineCardWidth: number = 634;
export const offlineCardHeight: number = 764;
...
export const profileImageWidth = 1500;
