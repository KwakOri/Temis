...
export const onlineCardWidth: number = 1141;
export const onlineCardHeight: number = 425;
...
export const offlineCardWidth: number = 1141;
export const offlineCardHeight: number = 425;
...
export const profileImageWidth = 1200;
export const profileImageHeight = 1800;
