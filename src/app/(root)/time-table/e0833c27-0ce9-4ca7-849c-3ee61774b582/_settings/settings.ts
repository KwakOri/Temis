...
export const onlineCardWidth: number = 846;
export const onlineCardHeight: number = 651;
...
export const offlineCardWidth: number = 846;
export const offlineCardHeight: number = 651;
