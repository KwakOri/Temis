...
export const onlineCardWidth: number = 903;
export const onlineCardHeight: number = 449;
...
export const offlineCardWidth: number = 994;
export const offlineCardHeight: number = 639;
