...
export const buttonThemes: TButtonTheme[] = [
  { value: "first", label: "보름달" },
  { value: "second", label: "초승달" },
];
...
export const onlineCardWidth: number = 516;
export const onlineCardHeight: number = 640;
...
export const offlineCardWidth: number = 516;
export const offlineCardHeight: number = 640;
...
export const profileImageWidth = 1100;
