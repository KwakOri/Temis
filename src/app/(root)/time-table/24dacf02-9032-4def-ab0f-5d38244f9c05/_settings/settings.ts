...
export const cardContainerHeight: number = Math.max(
  onlineCardHeight,
  offlineCardHeight
);
...
export const weekFlagCardWidth: number = 1800;
export const weekFlagCardHeight: number = 600;
...
export const profileBGWidth = 1417;
export const profileBGHeight = 1954;
