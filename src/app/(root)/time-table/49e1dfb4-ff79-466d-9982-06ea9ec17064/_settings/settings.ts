...
export const fontOption = {
  primary: "OnglippDaelong",
  secondary: "OngleebDaisy",
  tertiary: "",
  quaternary: "",
};
...
export const onlineCardWidth: number = 653;
export const onlineCardHeight: number = 538;
...
export const offlineCardWidth: number = 653;
export const offlineCardHeight: number = 538;
...
export const profileImageHeight = 1200;
