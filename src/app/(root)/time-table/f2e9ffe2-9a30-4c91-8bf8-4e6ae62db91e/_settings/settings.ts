...
export const onlineCardWidth: number = 847;
export const onlineCardHeight: number = 586;
...
export const offlineCardWidth: number = 847;
export const offlineCardHeight: number = 586;
...
export const profileImageWidth = 1260;
