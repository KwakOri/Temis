...
const CellTextMainTitle = ({
  ...
  return (
    <div
      ...
      className="flex justify-center items-center shrink-0 mt-3"
    >
      <AutoResizeText
        style={{
          color: colors[currentTheme || "first"]["primary"],
...
const CellTextTitle = ({ cellTextTitle }: CellTextSubTitleProps) => {
  return (
    ...
    // </p>
    <div className="flex justify-center items-center w-112 h-20">
      <AutoResizeText
        style={{
          fontFamily: fontOption.secondary,
          color: colors["first"]["primary"],
...
const TimeTableCell: React.FC<TimeTableCellProps> = ({
  ...
  return (
    ...
    >
      <CellContentArea>
        <div className="h-32 w-full mt-2.5 flex items-center">
          <div
          ...
          <div className="w-full h-full flex justify-center items-center pr-4 pb-2">
