...
export const BASE_FONTS = {
  PRIMARY: 'KblJump',
  SECONDARY: 'KblJump',
  TERTIARY: 'KblJumpCondensed',
  QUATERNARY: 'KblJumpExtended',
};
...
export const COMP_FONTS = {
  MAIN_TITLE: BASE_FONTS.QUATERNARY,
  ...
  ARTIST: BASE_FONTS.QUATERNARY,
  WEEKLY_MEMO: BASE_FONTS.QUATERNARY,
};
...
export const profileTextPlaceholder = '작가명 적는곳';
/** ---------------------------------------------- */
