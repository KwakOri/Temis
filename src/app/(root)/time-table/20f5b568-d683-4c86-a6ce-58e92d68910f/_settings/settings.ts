...
export const fontOption = {
  primary: "SchoolSafetyNotification-B",
  secondary: "SchoolSafetyNotification-R",
  tertiary: "",
  quaternary: "",
};
...
export const onlineCardWidth: number = 615;
export const onlineCardHeight: number = 671;
...
export const offlineCardWidth: number = 633;
export const offlineCardHeight: number = 412;
...
export const profileImageWidth = 1600;
export const profileImageHeight = 2130;
