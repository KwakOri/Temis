...
export const colors = {
  first: {
    primary: "#364025", // 메인 텍스트, 날짜
    secondary: "#70804C", // 서브 텍스트, 요일
    tertiary: "#FFFFFF", // 아티스트
    quaternary: "",
  },
  second: {
    primary: "",
...
export const onlineCardWidth: number = 613;
export const onlineCardHeight: number = 2043;
...
export const offlineCardWidth: number = 613;
export const offlineCardHeight: number = 2043;
...
export const profileImageWidth = 1360;
export const profileImageHeight = 2280;
