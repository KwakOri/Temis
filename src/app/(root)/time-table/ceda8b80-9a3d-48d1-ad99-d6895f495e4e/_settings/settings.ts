...
export const fontOption = {
  primary: "DnfTemperedBlade",
  secondary: "JoseonBoldMyongjo",
  tertiary: "",
  quaternary: "",
};
...
export const onlineCardWidth: number = 756;
export const onlineCardHeight: number = 755;
...
export const offlineCardWidth: number = 756;
export const offlineCardHeight: number = 755;
...
export const profileImageHeight = 2000;
