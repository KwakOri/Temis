...
export const BASE_FONTS = {
  PRIMARY: 'SchoolSafetyAttendanceBook',
  SECONDARY: 'SlowGothic',
  TERTIARY: '',
  QUATERNARY: '',
};
...
export const COMP_COLORS = {
  MAIN_TITLE: BASE_COLORS['first']['secondary'],
  SUB_TITLE: BASE_COLORS['first']['tertiary'],
  ...
  OFFLINE_MEMO: BASE_COLORS['first']['primary'],
};
