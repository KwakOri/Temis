...
export const onlineCardWidth: number = 831;
export const onlineCardHeight: number = 690;
...
export const offlineCardWidth: number = 831;
export const offlineCardHeight: number = 690;
...
export const profileImageHeight = 1480;
