...
export const onlineCardWidth: number = 616;
export const onlineCardHeight: number = 627;
...
export const offlineCardWidth: number = 616;
export const offlineCardHeight: number = 627;
...
export const profileImageWidth = 1332;
export const profileImageHeight = 1580;
