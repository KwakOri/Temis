...
export const onlineCardWidth: number = 746;
export const onlineCardHeight: number = 600;
...
export const offlineCardWidth: number = 746;
export const offlineCardHeight: number = 600;
...
export const profileImageWidth = 1800;
