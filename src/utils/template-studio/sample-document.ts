...
export const createSampleStudioDocument = (): StudioTemplateDocument => ({
  ...
  metadata: {
    ...
    name: "Input-bound Object Prototype",
    description: "Milestone A sample document",
  },
  canvas: {
    width: 960,
    height: 640,
  ...
  domains: {
    timetable: {
      ...
      days: {
        mon: { id: "mon", label: "Monday", shortLabel: "Mon", order: 0 },
        tue: { id: "tue", label: "Tuesday", shortLabel: "Tue", order: 1 },
        wed: { id: "wed", label: "Wednesday", shortLabel: "Wed", order: 2 },
        thu: { id: "thu", label: "Thursday", shortLabel: "Thu", order: 3 },
        fri: { id: "fri", label: "Friday", shortLabel: "Fri", order: 4 },
        sat: { id: "sat", label: "Saturday", shortLabel: "Sat", order: 5 },
        sun: { id: "sun", label: "Sunday", shortLabel: "Sun", order: 6 },
      },
      dayCardsLayout: {
        left: 434,
        top: 760,
