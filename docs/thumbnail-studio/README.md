...
최종 수정: 2026-08-29
상태: Phase 1~6 구현 완료, Phase 7 개선 및 Phase 8 자동 미리보기 코드 구현 완료 (공개 미리보기 정책 확정, 원격 migration 적용 대기)
...
| 08. 자동 미리보기 이미지 | 코드 구현 완료 (공개 URL 정책 확정, 원격 migration 적용 대기) | 발행 revision 기반 이미지 저장과 cover fallback |
