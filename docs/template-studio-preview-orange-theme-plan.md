...
7. [Runtime localization, week navigation, and global cards](./template-studio-preview-localization-week-global-cards-plan.md)

   Preview의 3개 언어 UI 기반, runtime 주간 이동, 의미 단위 Global input card 재구성을
   정의한다.
